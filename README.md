...
O app carrega um catálogo JSON local, mostra a hierarquia mínima de curso e registra progresso apenas em memória. Ainda não há jogo, síntese de voz, conteúdo pedagógico definitivo, persistência durável, backend ou importação de pacotes externos.
